...
import { isAppsScriptConfigured } from '../services/supabase';
...
const menuItems = [
  ...
  { name: 'Sekolah', path: '/sekolah', icon: 'bookopen' },
  { name: 'Perkembangan Belajar', path: '/perkembangan', icon: 'trending' },
  {
    ...
    icon: 'award',
    children: [
      { name: 'Nilai Tes Standar', path: '/nilai/standar', icon: 'filetext' },
          { name: 'Nilai SNBT-UTBK', path: '/nilai/snbt-utbk', icon: 'filetext' },
